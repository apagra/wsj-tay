...
public:
  ...
  // Second receive source. A null device means the user has not selected one
  // and only the first source should be opened.
  QAudioDeviceInfo const& audio_input_2_device () const;
  AudioDevice::Channel audio_input_2_channel () const;
  ...
  bool restart_audio_input_2 () const;
