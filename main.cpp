  ...
  try
    {
      ...
      SplashScreen splash;
      {
        // WSJT-Z opens with a splash carrying a donation appeal, dismissed by
        // a tick that is remembered. Nothing in the licence requires it, and
        // the credit it carries stays on the Help menu under About WSJT-Z, so
        // this build never shows it. The object itself is kept because
        // MainWindow takes it and hides it as it finishes starting up.
      }
